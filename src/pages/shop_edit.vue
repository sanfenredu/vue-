...
import axios from 'axios'
  export default {
    ...
    computed:{
        ...mapGetters(['get_shop_address_data','get_shop_categroy_data','get_shop_edit_data'])
    },
    methods: {
      ...mapActions(['getShopAddress','getShopCategroy','getShopEdit']),
      getAddress(){
    ...
    created(){
      ...
      this.getShopEdit( this.$route.params.id )
      this.get_shop_edit_data.then(res=>{
